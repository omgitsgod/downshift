...
describe('getInputProps', () => {
  ...
  describe('event handlers', () => {
    ...
    describe('on key down', () => {
      ...
      test('end it prevents the default event and the rerender only when menu is open', () => {
      ...
      test('home it prevents the default event and the rerender only when menu is open', () => {
        const {input, rerender, renderSpy} = renderCombobox()
      ...
      test('escape it prevents the rerender when menu closed, no selecteItem and no inputValue', () => {
      ...
      test('enter with closed menu, no item highlighted or composing event will not rerender or prevent event default', () => {
      ...
      test('tab it prevents the rerender when menu closed and does nothing', () => {
